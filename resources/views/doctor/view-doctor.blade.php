    ...
    <div class="card">
        ...
        <div class="card-header border-bottom">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h5 class="mb-0"> <i class="menu-icon tf-icons ti ti-users"> </i>
                        <b>User Management</b>
                    </h5>
                </div>
        ...
        <div class="container my-5 px-4">
            ...
            <div class="ps-2 mb-4">
                <hr>
                <h2 class="h4 mb-3"><b>Doctor Information</b></h2>
                <div class="row">
                    <div class="col-md-6 mb-2">
                        <p><strong>Doctor's Name:</strong> {{ $doctor->name }}</p>
                    </div>
                    <div class="col-md-6 mb-2">
                        <p><strong>Doctor's Gender:</strong> {{ $doctor->gender }}</p>
                    </div>
                    <div class="col-md-6 mb-2">
                        <p><strong>Doctor's Phone:</strong> {{ $doctor->phone }}</p>
                    </div>
                    <div class="col-md-6 mb-2">
                        <p><strong>Doctor's Address:</strong> {{ $doctor->address }}</p>
                    </div>
                    <div class="col-md-12">
                        <p><strong>Doctor's Designation:</strong> {{ $doctor->designation }}</p>
                    </div>
                </div>
            </div>
