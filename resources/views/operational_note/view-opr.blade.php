...
@section('title', 'View Operational Note')
    ...
    <div class="card">
        ...
        <div class="container my-2 px-4">
            ...
            <div class="ps-2">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <p><strong>Patient's name:</strong> {{ $note->patient->name }}</p>
                    </div>
                    <div class="col-md-4">
                        <p><strong>Patient's visit #:</strong> {{ $note->procedure_name }}</p>
                    </div>
                    {{-- <div class="col-md-4">
                        <p><strong>Patient's weight:</strong> {{ $note->$surgeon->name  }}</p>
                    </div> --}}
                    {{-- <div class="col-md-4">
                        <p><strong>Patient's pulse:</strong> {{  $note->$assistant->name }}</p>
                    </div> --}}
                    <div class="col-md-4">
                        <p><strong>Patient's blood_pressure:</strong> {{ $note->indication_of_surgery }}</p>
                    </div>
                    <div class="col-md-4">
                        <p><strong>Patient's temperature:</strong> {{ $note->operative_findings }}</p>
                    </div>
                    <div class="col-md-4">
                        <p><strong>Patient's respiratory:</strong> {{ $note->post_operation_orders }}</p>
                    </div>
                    <div class="col-4">
                        <p><strong>Patient's doctor:</strong> {{ $note->special_instruction }}</p>
                    </div>
                    <hr>
                </div>
            </div>
                ...
                html2canvas(modalContent).then(function(canvas) {
                    ...
                    header.onload = function() {
                        ...
                        footer.onload = function() {
                            ...
                            pdf.save('Operational_Note_Details.pdf');
                        };
                    };
                });
            });
