        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                <div class="avatar avatar-online">
                    <img src="{{ asset('assets/img/avatars/doctor.png') }}" alt class="h-auto rounded-circle">
                </div>
            </a>
            <ul class="dropdown-menu dropdown-menu-end">
                <li>
                    <a class="dropdown-item" href="{{ route('doctor.edit-password', Auth::user()->id) }}">
                        <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar avatar-online">
                                    <img src="{{ asset('assets/img/avatars/doctor.png') }}" alt
                                        class="h-auto rounded-circle">
                                </div>
                            </div>
                            <div class="flex-grow-1">
                                ...
                                <small class="text-muted">
                                    @if (Auth::check())
                                        Logged in as {{ Auth::user()->roles->pluck('name')->first() }}
                                    @else
                                        User
                                    @endif
                                </small>
