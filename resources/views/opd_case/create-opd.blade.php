...
@section('content')
    ...
    <div class="card mb-4">
        <div class="card-header border-bottom mb-4">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h5 class="mb-0">
                        <b><i class="menu-icon tf-icons ti ti-first-aid-kit"> </i></i>Create OPD</b>
                    </h5>
                </div>
            </div>
        </div>
        <form id="opd-case-form" class="card-body" action="{{ route('opd-case.store') }}" method="POST">
            @csrf
                ...
                <div class="col-md-4">
                    ...
                    <select class="select2 form-select text-capitalize" id="patient_id" name="patient_id">
                        ...
                        @foreach ($patients as $patient)
                            <option value="{{ $patient->id }}" data-visit="{{ $patient->opdCases->count() }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('opd-case-form').addEventListener('submit', function(event) {
                ...
                if (!isAppointmentDateValid || !isPatientSelected || !isDoctorSelected || !
                    isComplaintValid || !isHistoryValid || !isDiagnoseValid || !
                    isTreatmentValid || !isInstructionValid || !isFollowUpValid || !areMedicationsValid) {
