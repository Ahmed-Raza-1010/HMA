...
@section('content')
    ...
    <div class="card">
        ...
        <div class="container my-5 px-4">
            ...
            <div class="ps-2 mb-4">
                <hr>
                <h2 class="h4 mb-3"><b>Patient Information</b></h2>
                <div class="row">
                    <div class="col-md-6 mb-2">
                        <p><strong>Patient's Name:</strong> {{ $plan->patient->name }}</p>
                    </div>
                    <div class="col-md-6 mb-2">
                        <p><strong>Patient's Gender:</strong> {{ $plan->patient->gender }}</p>
                    </div>
                    <div class="col-md-6 mb-2">
                        <p><strong>Patient's Phone:</strong> {{ $plan->patient->phone }}</p>
                    </div>
                    <div class="col-md-6 mb-2">
                        <p><strong>Patient's Address:</strong> {{ $plan->patient->address }}</p>
                    </div>
                    <div class="col-md-12">
                        <p><strong>Patient's Diagnosis:</strong> {{ $plan->ipdCase->provisional_diagnose }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-4">
                <h2 class="h4 mb-3"><b>Discharge Plan</b></h2>
                <div class="row">
                    <div class="col-md-6 mb-2">
                        <p><strong>Operative Findings:</strong>{{ $plan->operative_findings }}</p>
                    </div>
                    <div class="col-md-6 mb-2">
                        <p><strong>Treatment in Hospital:</strong> {{ $plan->treatment_in_hospital }}</p>
                    </div>
                    <div class="col-md-6 mb-2">
                        <p><strong>Treatment for Home:</strong> {{ $plan->treatment_in_home }}</p>
                    </div>
                    <div class="col-md-6 mb-2">
                        <p><strong>Special Instruction:</strong> {{ $plan->ipdCase->special_instruction }}</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                html2canvas(modalContent).then(function(canvas) {
                    ...
                    header.onload = function() {
                        ...
                        footer.onload = function() {
                            ...
                            pdf.save('Discharge_Plan_Details.pdf');
                        };
                    };
                });
            });
