    ...
    <div class="card">
        ...
        <div class="card-header border-bottom">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h5 class="mb-0"><i class="menu-icon tf-icons ti ti-emergency-bed"> </i>
                        <b>IPD Management</b>
                    </h5>
                </div>
        ...
        <div class="container my-2 mb-4">
            ...
            <div class="ps-2">
                ...
                <div class="row">
                    <div class="col-md-4 mb-0">
                        <p><strong>Name:</strong> {{ $ipdCase->patient->name }}</p>
                    </div>
                    <div class="col-md-4 mb-0">
                        <p><strong>Visit No#:</strong> {{ $ipdCase->visit_no }}</p>
                    </div>
                    <div class="col-md-4 mb-0">
                        <p><strong>Height:</strong> {{ $ipdCase->patient->height . ' ft in' }}</p>
                    </div>
                    <div class="col-md-4 mb-0">
                        <p><strong>Weight:</strong> {{ $ipdCase->patient->weight . ' kg' }}</p>
                    </div>
                    <div class="col-md-4 mb-0">
                        <p><strong>Pulse:</strong> {{ $ipdCase->patient->pulse . ' bpm' }}</p>
                    </div>
                    <div class="col-md-4 mb-0">
                        <p><strong>Blood Pressure:</strong> {{ $ipdCase->patient->blood_pressure . ' mm Hg' }}</p>
                    </div>
                    <div class="col-md-4 mb-0">
                        <p><strong>Temperature:</strong> {{ $ipdCase->patient->temperature . ' °C' }}</p>
                    </div>
                    <div class="col-md-4 mb-0">
                        <p><strong>Respiratory:</strong> {{ $ipdCase->patient->respiratory }}</p>
                    </div>
                    <div class="col-md-4 mb-0">
                        <p><strong>Doctor:</strong> {{ $ipdCase->doctor->name }}</p>
                    </div>
                    <div class="col-md-4 mb-0">
                        <p><strong>Bed No#:</strong> {{ $ipdCase->bed }}</p>
                    </div>
                    <hr>
                </div>
            </div>
            ...
            <div class="col-md-12 m-0">
                <p><strong>Patient's complain:</strong> {{ $ipdCase->presenting_complaint }}</p>
            </div>
            <div class="col-md-12 m-0">
                <p><strong>Patient's history:</strong> {{ $ipdCase->history }}</p>
            </div>
            <h2 class="h4 mb-3"><b>Examination</b></h2>
            <div class="col-md-12 m-0">
                <p><strong>Patient's diagnose:</strong> {{ $ipdCase->provisional_diagnose }}</p>
            </div>
            <div class="col-md-12 m-0">
                <p><strong>Patient's treatment:</strong> {{ $ipdCase->treatment }}</p>
            </div>
