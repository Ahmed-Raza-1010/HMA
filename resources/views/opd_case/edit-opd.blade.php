...
@section('content')
    ...
    <div class="card mb-4">
        <div class="card-header border-bottom mb-4">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h5 class="mb-0">
                        <b><i class="menu-icon tf-icons ti ti-first-aid-kit"> </i></i>Edit OPD</b>
                    </h5>
                </div>
            </div>
        </div>
        <form id="opd-case-form" class="card-body" action="{{ route('opd-case.update', $opdCase->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="text" id="patient_id" name="patient_id" class="form-control"
                        value="{{ old('patient_id', $opdCase->patient->name) }}" readonly />
                </div>
                <div class="col-md-4">
                    <label class="form-label" for="visit_no">Visit.No/OPD.No</label>
                    <input type="text" id="visit_no" name="visit_no" class="form-control" placeholder="1"
                        value="{{ old('visit_no', $opdCase->visit_no) }}" readonly />
                </div>
                <hr />
                <div class="col-md-4">
                    <label class="form-label" for="height">Height</label>
                    <input type="text" id="height" name="height" class="form-control"
                        value="{{ old('height', $opdCase->patient->height . ' ft in') }}" readonly />
                </div>
                <div class="col-md-4">
                    <label class="form-label" for="weight">Weight</label>
                    <input type="text" id="weight" name="weight" class="form-control"
                        value="{{ old('weight', $opdCase->patient->weight . ' kg') }}" readonly />
                </div>
                <div class="col-md-4">
                    <label class="form-label" for="pulse">Pulse</label>
                    <input type="text" id="pulse" name="pulse" class="form-control"
                        value="{{ old('pulse', $opdCase->patient->pulse . ' bpm') }}" readonly />
                </div>
                <div class="col-md-4">
                    ...
                    <input type="text" id="blood_pressure" name="blood_pressure" class="form-control"
                        value="{{ old('blood_pressure', $opdCase->patient->blood_pressure . ' mm Hg') }}" readonly />
                </div>
                <div class="col-md-4">
                    <label class="form-label" for="temperature">Temperature</label>
                    <input type="text" id="temperature" name="temperature" class="form-control"
                        value="{{ old('temperature', $opdCase->patient->temperature . ' °C') }}" readonly />
                </div>
                <div class="col-md-4">
                    ...
                    <input type="number" id="respiratory" name="respiratory" class="form-control"
                        value="{{ old('respiratory', $opdCase->patient->respiratory) }}" readonly />
                </div>
                <div class="col-md-4">
                    ...
                    <input type="text" id="appointment" name="appointment" class="form-control dob-picker"
                        placeholder="YYYY-MM-DD" value="{{ old('appointment', $opdCase->appointment_date) }}" />
                    ...
                    <select class="select2 form-select text-capitalize" id="doctor_id" name="doctor_id">
                        ...
                        @foreach ($doctors as $doctor)
                            <option value="{{ $doctor->id }}"
                                {{ old('doctor_id', $opdCase->doctor_id) == $doctor->id ? 'selected' : '' }}>
                                {{ $doctor->id }}{{ ' - ' }}{{ $doctor->name }}
                            </option>
                        @endforeach
                    </select>
                    <span id="doctor-error" style="color: red; display: none;">Please select a doctor.</span>
                </div>
            </div>
            <hr />
            <h6>COMPLAINT</h6>
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <textarea id="complaint" name="complaint" class="form-control" placeholder="Complaint here"
                        style="height: 110px; resize: none;">{{ old('complaint', $opdCase->presenting_complaint) }}</textarea>
                ...
                <div class="col-md-4">
                    ...
                    <textarea id="history" name="history" class="form-control" placeholder="History here"
                        style="height: 110px; resize: none;">{{ old('history', $opdCase->history) }}</textarea>
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <textarea id="diagnose" name="diagnose" class="form-control" placeholder="Write provisional diagnose"
                        style="height: 110px; resize: none;">{{ old('diagnose', $opdCase->provisional_diagnose) }}</textarea>
                ...
                <div class="col-md-4">
                    ...
                    <textarea id="treatment" name="treatment" class="form-control" placeholder="Write about treatment"
                        style="height: 110px; resize: none;">{{ old('treatment', $opdCase->treatment) }}</textarea>
                ...
                <div class="col-md-4">
                    ...
                    <textarea id="instruction" name="instruction" class="form-control" placeholder="Instructions here"
                        style="height: 110px; resize: none;">{{ old('instruction', $opdCase->special_instruction) }}</textarea>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" id="follow_up" name="follow_up" class="form-control"
                        value="{{ old('follow_up', $opdCase->follow_up_days) }}" placeholder="5" />
            ...
            <div class="pt-4">
                ...
                <button type="reset" onclick="window.location.href='{{ route('opd-case.index') }}'"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const fieldsToValidate = ['#respiratory', '#complaint', '#history', '#diagnose', '#treatment',
                '#instruction'
            ];
            ...
            attachEventListener('#opd-case-form', 'submit', function(event) {
